...
interface YuanShenPool : CardPool {
    ...
    override operator fun invoke(result: CardSettle) = with(result) {
        when {
    ...
    override fun getResult(cardSettle: CardSettle) = when (cardSettle.level) {
        5 -> upFive
        4 -> normalFive
        3 -> upFour
        2 -> normalFour
    ...
    object WenDiPool : YuanShenPool {
        override val name = "温迪"

        override val upFive = arrayOf("温迪")
        override val normalFive = arrayOf("刻晴", "莫娜", "七七", "迪卢克", "琴")
        override val upFour = arrayOf("香菱", "菲谢尔", "芭芭拉")
        override val normalFour = arrayOf(
            "重云",
            "班尼特",
            "行秋",
    ...
    object HuTaoPool : YuanShenPool {
        override val name = "胡桃"

        override val upFive = arrayOf("胡桃")
        override val normalFive = arrayOf("刻晴", "莫娜", "七七", "迪卢克", "琴")
        override val upFour = arrayOf("香菱", "行秋", "重云")
        override val normalFour = arrayOf(
            "诺艾尔",
            "班尼特",
            "菲谢尔",
    ...
    object ZhongLiPool : YuanShenPool {
        override val name = "钟离"

        override val upFive = arrayOf("钟离")
        override val normalFive = arrayOf("刻晴", "莫娜", "七七", "迪卢克", "琴")
        override val upFour = arrayOf("辛焱", "雷泽", "重云")
        override val normalFour = arrayOf(
            "凝光",
            "砂糖",
            "行秋",
